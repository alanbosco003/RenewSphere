...
class SampleModuleScreen extends ReactiveStateWidget<SampleModuleController> {
  ...
  BindController<SampleModuleController>? bindController() {
    return BindController(
        controller: () => SampleModuleController(), autoDispose: true);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Observer2<ServiceState, List<PhotosData>>(
          listenable: controller.sampleHandler.serviceState,
          listenable2: controller.sampleHandler.photos,
          listener: (state, photos) {
